...
\paragraph*{Shamir's Secret Sharing} erlaubt das Aufteilen eines Secrets $s$ über $T$ Personen, wobei $n \leq T$ Personen für das Öffnen des Schlüssels benötigt werden. Dazu wird das Secret in einer Funktion $(n-1)$-ten Grades mit folgenden Aufbau versteckt:
