...
\end{itemize}
Das Protokoll ist sicher gegen $n - 1$ passive Gegner. Eine obere Grenze an die Summe $m$ wird dabei als bekannt vorausgesetzt (in diesem Beispiel 3). Nach Anpassen des Modulus können Alice, Bob und Charlie dieses Protokoll z.B. auch dafür verwenden, sicher ihren Notendurchschnitt berechnen.
