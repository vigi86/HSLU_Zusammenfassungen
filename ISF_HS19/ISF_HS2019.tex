...
\paragraph*{Sicherheitsrelevante Response-Header}\index{Response-Header}
\begin{enumerate}[noitemsep,topsep=0pt,leftmargin=*]
...
\paragraph*{CSRF - Cross-Site Request Forgery}\index{CSRF}Was ist das?\\
...
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
    \item ISO 27001 ist eine Norm/Standard der "`High Level"' beschreibt, an was zu denken ist (Organisation, Planung, Riskmanagement)
    ...
    \begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
        \item Aufgeteilt in Gefahren/Anforderungen und Massnahmen, geglieder in Bausteine
    \end{itemize}
\end{itemize}
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
    \item Warum ist der IT-Grundschutz vollständig?
    \item Er srpicht serh viele IT Sicherheits-Thmemen in einem breiten Spektrum an
    \item Warum ist es nicht vollständig?
    \item Es ist fast unmöglich einen vollständigen Katalog mit allen aktuellen Gefahren und Massnahmen zu haben -> aber ein gutes Nachschlagewerk
    \item Was sind Bausteine?
    \item Buasteine sind unterteilt in Katergorien z.b. Netzwerk und Gefahren(FW) Massnahmen (Updates)
\end{itemize}
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=6.5cm]{images/NISTcomponents.png}
...
\paragraph*{Fünf Funktionen der Cybersicherheitsaufgaben}
    \begin{center}
    \includegraphics[width=6.5cm]{images/NISTfunctions.png}
...
\\
\textgreater Dynamic white-listing with URL encryption = positive security model
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
