...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=8cm]{images/IT-Grundschutz-Aufbau.png}
...
\paragraph*{Warum ist der IT Grundschutz vollständig?}
Er spricht \textbf{sehr} viele IT Sicherheits-Themen in einem breiten Spektrum an.

\paragraph*{Warum ist der IT Grundschutz nicht vollständig?} Es ist fast unmöglich einen vollständigen Katalog mit allen aktuellen Gefahren und Massnahmen zu haben \textgreater aber ein gutes Nachschlagewerk
...
Hier noch ein Ausschnitt der Bausteine aus der Seite vom BSI.bund.de:
\begin{figure}[H]
    \begin{center}
...
\subsubsection*{OWASP TOP 10}\index{OWASP}
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=8cm]{images/OWASP_Top_10.png}
