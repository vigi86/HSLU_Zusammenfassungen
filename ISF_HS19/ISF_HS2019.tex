...
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
    \item \textbf{\textsl{Zutrittskontrolle: }}Schutz des physischen Systems (Bsp. Serverraum)\index{Kontrollen!Zutrittskontrolle}
    \item \textbf{\textsl{Zugangskontrolle: }}Schutz des logischen Systems (Bsp. Betriebssystem)\index{Kontrollen!Zugangskontrolle}
    \item \textbf{\textsl{Zugriffskontrolle: }}Daten-bezogen; Schutz der Operationen (Bsp. Dateisystem)\index{Kontrollen!Zugriffskontrolle}
\end{itemize}
...
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
    \item \textbf{\textsl{Verfügbarkeit:}} Zur gewünschten Zeit kann vom Benutzer auf die Daten zugegriffen werden und der Dienst funktioniert (Ausfallquote)\index{Grundziel!Verfügbarkeit}
    \item \textbf{\textsl{Integrität:}} Gewährleistung das Daten nicht unautorisiert oder zufällig manipuliert werden können. (Datensicherheit)\index{Grundziel!Integrität}
    \item \textbf{\textsl{Verbindlichkeit:}} Handlung kann eindeutig einer Person zugeordnet werden und von dieser auch nicht geleugnet werden.\index{Grundziel!Verbindlichkeit}
    \item \textbf{\textsl{Vertraulichkeit:}} Informationen können nicht von unautorisierten Personen, Instanzen und/oder Prozessen eingesehen werden.\index{Grundziel!Vertraulichkeit}
\end{itemize}
\noindent
\paragraph*{Beispiele}
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
...
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
    \item Risiko: Gefahr, Problem welches entstehen kann.\index{Risikoanalyse!Risiko}
    \item Sicherheit: Schutz vor Risiko\index{Risikoanalyse!Sicherheit}
    \item Eintretenshäufigkeit: Wahrscheinlichkeit, dass Risiko eintritt\index{Risikoanalyse!Eintretenshäufigkeit}
    \item Restrisiko: Sicherheit deckt einen Teil des Risikos ab, jedoch nur gewisses Budget, somit bleibt Restrisiko, z.B. Erdbeben in San~Francisco oder Istanbul\index{Risikoanalyse!Restrisiko}
\end{itemize}
...
\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
    ...
    \begin{figure}[ht]
        ...
        \label{coa}
        \end{center}
    \end{figure}\index{Angriffsarten!Ciphertext only attack}
    ...
    \begin{figure}[ht]
        ...
        \label{kpa}
        \end{center}
    \end{figure}\index{Angriffsarten!Known plaintext attack}
    ...
    \begin{figure}[ht]
        ...
        \label{cpa}
        \end{center}
    \end{figure}\index{Angriffsarten!Chosen plaintext attack}
\end{itemize}
...
\paragraph*{}Die 7 Tierschichten des OSI-Models, wobei die 8te sich auf den Mensch bezieht.
...
\paragraph*{}Die 7 Tierschicht des OSI-Models, wobei die 8te sich auf den Mensch bezieht.
