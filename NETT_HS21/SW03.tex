...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item \textsl{\dots{}an die richtigen Steckplätze hergestellt wird.}
    \end{itemize}
...
\paragraph*{Gängigste Topologie-Typen}\index{Netzwerk!Topologie}
\begin{itemize}
    \item Bus
    \begin{itemize}
        \item Vorteile
...
\subsection*{Was ist \flqq{}Latency\frqq{} und \flqq{}Jitter\frqq? Wie kann man diese Konzepte visualisieren und verstehen?}\index{Latency}\index{Jitter}
...
\subsection*{Was für Kupferkabelarten werden heutzutage in Computernetzwerken am häufigsten verwendet?}\index{Kupferkabel}
Unshielded Twisted-Pair (UTP), Shielded Twisted-Pair (STP) und Coaxial-Kabel.

\subsubsection*{Wie sind sie aufgebaut?\footnote{Quellen?}}
\begin{multicols*}{2}
...
Anfällig für Interferenzen, leitet Strom.

\pagebreak
\section{Antworten T4}
\subsection*{Was sind die wichtigsten Merkmale von Glasfaserkabeln?}\index{Glasfaserkabel}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \begin{center}
            ...
            \includegraphics[width=.3\textwidth]{images/optical_fibre_structure.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=.7\textwidth]{images/Tipos_conectores_fibra_optica.jpg}
...
\subsection*{Wo ist der Unterschied zwischen Multi- und Singlemode (Monomode)- Glasfasern?\footnote{Quellen?}}\index{Glasfaserkabel!Multimode}\index{Glasfaserkabel!Singlemode}
\begin{multicols}{2}
    \begin{figure}[H]
        \begin{center}
        \label{pic:Monomode}
