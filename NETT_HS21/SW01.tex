...
Ein \textbf{LAN} beschränkt sich auf das interne Netzwerk einer Firma oder privat in der Wohnung. Es gibt private IP-Adressen, welche nur im Intranet existieren. (//TODO Referenz) Ein \textbf{WAN} ist einfach ausgedrückt das Internet. Die Beziehung zueinander ist so, dass man normalerweise vom LAN auf das WAN zugreifen kann, umgekehrt aber nicht. Weitere Infos über IPs siehe \hyperref[part:sw0506]{\underline{\nameref{part:sw0506}, Seite \pageref{part:sw0506}}}
